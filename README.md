...
В файлах также представлены файлы "file1.txt" и "file2.txt", на которых рекомендуется тестировать программу. Представленные текстовые документы демонстрируют время работы программы, в зависимости от количества чисел в файлах. В "file1.txt" находятся 2000 чисел, в "file2.txt" - 64000 чисел.

Для проверки работоспосбости данной программы, рекомендуется скачать предложенные файлы и саму программу, для корректной работы добавив все в одну папку.
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(_sum(arrayList));
        System.out.println(_mult(arrayList));
    }

    public static ArrayList<BigInteger> getDataFromFile(String fileName) {
